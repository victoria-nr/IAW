...
En última instancia, nuestro workflow construye la nueva imagen de Docke usando el Dockerfile disponible en nuestro repositorio y hace *push* de la imagen construida tanto a Docker Hub como a Github Container Regsitry.
